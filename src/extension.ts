...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "encode-and-paste" is now active!');
	...
	let disposable = vscode.commands.registerCommand('encode-and-paste.paste', () => {
		// The code you place here will be executed every time your command is executed
        paster.paste();
		// Display a message box to the user
        vscode.window.showInformationMessage('pasted encorded text!');
	});
...
export class Paster {
    ...
    generateEncodedText(content) {
        ...
        var prefix = vscode.workspace.getConfiguration('encodeAndPaste').get('prefix');
